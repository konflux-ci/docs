...
If you ever need to restore the default EC integration test to an application, or if you want to use a different configuration of the EC as an integration test, see our link:https://konflux-ci.dev/docs/how-tos/testing/integration/adding/[Adding an intergration test] guide.
