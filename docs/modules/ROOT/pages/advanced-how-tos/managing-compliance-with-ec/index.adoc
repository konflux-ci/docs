...
If you ever need to restore the default EC integration test to an application, or if you want to use a different configuration of the EC as an integration test, see our xref:/how-tos/testing/integration/adding.adoc[Adding an intergration test] guide.
