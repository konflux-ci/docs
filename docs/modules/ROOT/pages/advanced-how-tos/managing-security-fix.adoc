...
* You have the Maintainer role or greater in the original workspace where the embargoed issue was identified.
...
[IMPORTANT]
====
* If you already have a private workspace that you used for another embargoed issue, you can re-use it. Always double-check the link:https://console.redhat.com/preview/application-pipeline/access[User Access] permissions.

* You can reuse a personal workspace, but double-check the User Access permissions.
====
...
. Invite reviewers from your security department or select members from your team to review the patch and confirm that it fixes the embargoed security issue by granting them collaborator rights in your workspace.
