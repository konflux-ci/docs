...
.. While editing the component, update the pipeline to one of the xref:/advanced-how-tos/installing/enabling-builds.adoc#customize-pipelines[configured pipelines] and add the request to configure PAC to `metadata.annotations`.
