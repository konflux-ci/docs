...
----
This command adds the Snapshot to your workspace and integration service will test and potentially trigger a release of the Snapshot if you have xref:/advanced-how-tos/releasing/create-release-plan.adoc[automatic Releases defined].
