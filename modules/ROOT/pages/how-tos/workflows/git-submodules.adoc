...
include::ROOT:partial$how-tos/workflows/{context}-submodules-source-control.adoc[]
...
include::ROOT:partial$how-tos/workflows/{context}-submodules-renovate.adoc[]
...
include::ROOT:partial$how-tos/workflows/{context}-submodules-example-downstream-containerfile.adoc[]
...
include::ROOT:partial$how-tos/workflows/{context}-submodules-example-args-file.adoc[]
