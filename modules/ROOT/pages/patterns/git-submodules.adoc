...
include::ROOT:partial$patterns/{context}-submodules-source-control.adoc[]
...
include::ROOT:partial$patterns/{context}-submodules-renovate.adoc[]
...
include::ROOT:partial$patterns/{context}-submodules-example-downstream-containerfile.adoc[]
...
include::ROOT:partial$patterns/{context}-submodules-example-args-file.adoc[]
