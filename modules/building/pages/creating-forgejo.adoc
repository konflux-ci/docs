...
If you use this value, a pull request is not created during onboarding,
...
. After the pull request is created, a build pipeline starts. Track its progress in the {ProductName} UI or see the final status in Forgejo after the pipeline completes. If the pipeline is successful, merge the pull request.
