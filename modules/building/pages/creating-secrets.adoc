...
Some source control providers require authentication secrets before onboarding components. See xref:building:creating-scm-secrets.adoc[Creating source control management secrets] for detailed instructions.
