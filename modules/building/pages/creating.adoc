...
+
NOTE: You can create additional applications by adding their custom resource configurations to the `Application.yaml` file. Separate multiple resources with `---`:
+
[source,yaml]
----
# Application A
...
+
NOTE: You can create additional components by adding their custom resource configurations to the YAML files. Separate multiple resources with `---`:
+
[source,yaml]
----
# Component A
