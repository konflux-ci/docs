...
|xref:building:creating-gitlab.adoc#creating-a-gitlab-source-control-secret[Create a source control secret] before onboarding
|===
...
|GitLab
|xref:building:creating-gitlab.adoc[Onboarding a component from GitLab with the CLI] (requires xref:building:creating-secrets.adoc#creating-source-control-secrets[source control secrets])
|===
