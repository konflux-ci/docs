...
IMPORTANT: Refer to link:https://hermetoproject.github.io/hermeto/usage[Hermeto Usage] for more detail on Hermeto configuration and usage.

        Note that while there are some differences between using `hermeto` as a command-line tool, and running it in a pipeline (i.e. in {ProductName}), the most important usage pattern is the same, namely:

        **Always** use JSON-formatted input to Hermeto when running in a pipeline environment (e.g. in {ProductName}, include it in the task definition). Check the walkthrough for the specfic package manager you're using if you're not certain as to how it should work.
...
Refer to the link:https://hermetoproject.github.io/hermeto/gomod/#example[gomod walkthrough] for a detailed example of using gomod with Hermeto.

IMPORTANT: Note that while there are some differences between using `hermeto` as a command-line tool, and running it in a pipeline (i.e. in {ProductName}), the most important usage pattern is the same, namely:

        **Always** use JSON-formatted input to Hermeto when running in a pipeline environment (e.g. in {ProductName}, include it in the task definition). Check the walkthrough linked above if you're not certain as to how it should work.
...
Refer to the link:https://hermetoproject.github.io/hermeto/pip/#example[pip walkthrough] for a detailed example of using pip with Hermeto.

IMPORTANT: Note that while there are some differences between using `hermeto` as a command-line tool, and running it in a pipeline (i.e. in {ProductName}), the most important usage pattern is the same, namely:

**Always** use JSON-formatted input to Hermeto when running in a pipeline environment (e.g. in {ProductName}, include it in the task definition). Check the example if you're not certain as to how it should work.
...
Refer to the link:https://hermetoproject.github.io/hermeto/npm/#example[npm walkthrough] for a detailed example of using npm with Hermeto.
...
Refer to the link:https://hermetoproject.github.io/hermeto/yarn/#example[yarn walkthrough] for a detailed example of using yarn with Hermeto.
...
Refer to the link:https://hermetoproject.github.io/hermeto/bundler/#hermetic-build[bundler walkthrough] for a detailed example of using bundler with Hermeto.
...
Refer to the link:https://hermetoproject.github.io/hermeto/cargo/#example[cargo walkthrough] for a detailed example of using cargo with Hermeto.
...
Refer to the link:https://hermetoproject.github.io/hermeto/rpm/#example[rpm walkthrough] for a detailed example of using rpm with Hermeto.

IMPORTANT: You *must* take into account the differences between using Hermeto in a pipeline, and using `hermeto` as a command-line tool.
...
Refer to the link:https://hermetoproject.github.io/hermeto/generic/#example[generic fetcher walkthrough] for a detailed example of using generic with Hermeto.
