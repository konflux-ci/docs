...
Notice that you don't need to generate a `requirements-build.txt` file as described in the section above in case the prefetching of wheels is enabled.
