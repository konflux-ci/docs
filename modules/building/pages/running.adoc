...
link:https://pipelinesascode.com/docs/guides/running-pipelines/[Running the PipelineRun] for more information.
...
+
NOTE: There are rules that govern who can execute the `/retest` comment. They follow the same requirements as determining whether a submitter is allowed to run the PipelineRun. Please see link:https://pipelinesascode.com/docs/guides/running-pipelines/[Running the PipelineRun].


+
NOTE: For additional options, refer to the link:https://pipelinesascode.com/docs/guides/gitops-commands/[Pipelines as Code documentation].
...
See link:https://pipelinesascode.com/docs/guides/event-matching/[Matching Events with Pipelines as Code]
...
+
NOTE: For instructions on how to retrigger only individual build pipelines, not all, see link:https://pipelinesascode.com/docs/guides/gitops-commands/[pipelinesascode documentation].
