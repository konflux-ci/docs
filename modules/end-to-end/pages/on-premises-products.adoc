...
[NOTE]
====
Firefox has built-in remote DNS support, but other browsers, like Chrome and Edge, don't, so you'll need to look for a plugin like *Proxy SwitchyOmega* or *FoxyProxy* to handle DNS resolution for you.
====
