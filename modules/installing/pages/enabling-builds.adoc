...
* To verify that you successfully enabled build pipelines, a user should try to xref:building:applications-components/creating.adoc[create an application].
