...
In case `renovate.json` file was added to a repository it can be validated with this https://github.com/konflux-ci/renovate-config-validator-action[GitHub Action].
