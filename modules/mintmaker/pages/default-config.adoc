...
The `tekton` manager is pointed to the `.tekton/` directory and updates for `quay.io/konflux-ci/tekton-catalog`
images are grouped into a single PR/MR by default. It also includes links to CHANGELOG.md files for the updated tasks.
