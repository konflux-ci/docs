...
| *`onFail`* __string__ | OnFail defines how to behave if this IntegrationTestScenario fails. +
Options: "run" (default) - continue running dependent tests, "skip" - skip dependent tests + | run | Enum: [run skip] +
