...
1. Create the registry pull secret in your tenant namespace - consult the  xref:building:secrets/index.adoc#creating-registry-pull-secrets[guide for pull secret creation].
