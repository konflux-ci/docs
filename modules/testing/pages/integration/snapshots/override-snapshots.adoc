...
----
<1> The label `test.appstudio.openshift.io/type: override` that indicates this is an `override` snapshot. This is required in order for the override snapshot to be tested properly
