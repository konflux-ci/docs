...
{ProductName} uses image scanning tools in order to get vulnerabilities. All of those tests play informative role so user is acknowledged about CVEs on their product(image).
